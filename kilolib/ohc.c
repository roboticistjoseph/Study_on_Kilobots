 ...
 * @author Team Harvard
 *
 * @brief This file contains the implementation of the OHC firmware for a microcontroller (AVR/Arduino). 
 * @version 0.1
 * @date 2023-02-17
 * 
...
/**
 * @brief The main function that runs the OHC firmware
 *
 * This function initializes the necessary components, waits for incoming packets, and
 * processes the incoming packets based on their type. The function also sends out 
 * processed packets to other OHC devices.
 * 
 * @return int 
 */
int main() {
