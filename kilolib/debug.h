 ...
 * @author Team Harvard
 *
 * @brief Debug utilities for AVR microcontrollers
 * @version 0.1
 * @date 2023-02-17
 * 
 ...
 *
 * This function initializes the debug output by setting up the UART with the specified baud rate and
 * configuring the output pins. It also sets up the standard output stream so that printf() calls are
 * directed to the debug output.
 */
void debug_init() {
